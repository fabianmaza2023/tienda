                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $parametro = null;
                            $datosClientes = ControladorClientes::ctrlCargarCliente($parametro, 0);
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <button class='btn btn-warning btnCargarDatos' idClientes='".$valor['id_persona']."' data-toggle='modal' data-target='#modificar'><i class='fas fa-edit'></i></button>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="input-group mb-3">
                                    <input type="email" class="form-control" placeholder="Email" name="modificar_email" id="modificar_email" required>
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                                    </div>
                                </div>
